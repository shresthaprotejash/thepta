	...
	<div class="wrapper">
		<div class="sidebar" data-color="blue"
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					<li class="active"><a href="/THEPTA/dashboard"> <i
							class="pe-7s-graph"></i>
							<p>Dashboard</p>
					</a></li>

					<li><a href="/THEPTA/userprofile"> <i class="pe-7s-user"></i>
							<p>User Profile</p>
					</a></li>
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row" align="center">
						<div class="col-sm-3">
							<div class="card"
								onclick="location.href='dashboard/uploadattendance';">
								<div class="card-content">
									<img
										src="${pageContext.request.contextPath}/resources/img/attendance.png">
									Upload Attendance
								</div>
							</div>
						</div>
						...
						<div class="col-sm-3">
							<div class="card"
								onclick="location.href='dashboard/uploadmarks';">
								<div class="card-content">
									<img
										src="${pageContext.request.contextPath}/resources/img/performance.png">
									Upload marks
								</div>
							</div>
						</div>
						...
						<div class="col-sm-3">
							<div class="card" onclick="location.href='#';">
								<div class="card-content">
									<img
										src="${pageContext.request.contextPath}/resources/img/chat.png">
									Chat with Parents
								</div>
							</div>
						</div>
						...
						<div class="col-sm-3">
							<div class="card"
								onclick="location.href='dashboard/uploadtestandhomework';">
								<div class="card-content">
									<img
					...
					<div class="row" align="center">
						<div class="col-sm-3">
							<div class="card"
								onclick="location.href='dashboard/viewattendance';">
								<div class="card-content">
									<img
										src="${pageContext.request.contextPath}/resources/img/attendance.png">
									View Attendance
						...
						<div class="col-sm-3">
							<div class="card"
								onclick="location.href='dashboard/viewhwandtest';">
								<div class="card-content">
									<img
										src="${pageContext.request.contextPath}/resources/img/homework.png">
									View Test/Homework
						...
						<div class="col-sm-3">
							<div class="card"
								onclick="location.href='dashboard/uploadcircular';">
								<div class="card-content">
									<img
										src="${pageContext.request.contextPath}/resources/img/circular.png">
									Upload Circular
								</div>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="card"
								onclick="location.href='dashboard/viewcircular';">
								<div class="card-content">
									<img
										src="${pageContext.request.contextPath}/resources/img/circular.png">
									View Circular
