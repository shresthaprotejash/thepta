...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="sub-nav">      
            <a href="/THEPTA/dashboard/viewtest">
                <h5><span class="glyphicon glyphicon-chevron-left"></span></a>View Classtest</h5>              
        </div>
                    ...
                    <div class="col-md-10  col-md-offset-1">
                        <div class="u-card">
                            <div class="content">
							  ...
							  <TH width="200">SYLLABUS</TH>
							  <TH width="100">TEXT BOOK</TH>
                               ...
                               <TR>
                                  ...
                                  <TD>MOCK TEST</TD>
                                  <TD>II</TD>
								  <TD>exrecise no 1.1-exercise no 2.3</TD>
                               ...
                               <TR>
                                  ...
                                  <TD>CLASS TEST</TD>
                                  <TD>I</TD>
								  <TD>exrecise no 1.5-exercise no 2.0</TD>
								  <TD>math is fun</TD>
