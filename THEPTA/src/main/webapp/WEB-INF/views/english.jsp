...
<div class="wrapper">
  ...
  <div class="w3-card-4" style="width:100%">
    <header class="w3-container w3-light-grey">
      <h3>Ms Reshma Reddy</h3>
    </header>
    <div class="w3-container">
		<br>
      <p>period no : II </p>
	  <p>time: 9:05am-10:10am</p>
      <hr>
	  <div class="author">
      <a href="#">
      <img src="${pageContext.request.contextPath}/resources/img/faces/teacher1.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
	  </a>
	  </div>
      <p>dear parent</p>
	  <p>please help your child to maintain his/her notebook/textbook clean.<br>regards</p>
