...
<div class="wrapper">
  ...
  <div class="w3-card-4" style="width:100%">
    <header class="w3-container w3-light-grey">
      <h3>Mr Raushan Kumar</h3>
    </header>
    <div class="w3-container">
		<br>
      <p>period no : IV </p>
	  <p>time: 1:05pm-2:10pm</p>
      <hr>
	  <div class="author">
      <a href="#">
      <img src="${pageContext.request.contextPath}/resources/img/faces/teacher3.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
	  </a>
	  </div>
      <p>dear parent</p>
	  <p>your child is doing great work.We thanks you to giving your proper attention on him.please check class test updates.<br>regards</p>
