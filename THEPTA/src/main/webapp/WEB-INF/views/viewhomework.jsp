					...
					<div class="row">
						<div class="col-md-10  col-md-offset-1">
							<div class="u-card">
										...
										<TABLE BORDER="3" align="center" class="table">
											...
											<c:forEach items="${homeworklist}" var="homeworkList">
												<TR>
													...
													<TD>
														<div class="btn-group">
															<div onclick="switched(${homeworkList.subjectId});"
																class="btn btn-primary">Get</div>
														</div>
													</TD>
								...
								<c:forEach items="${homeworklist}" var="homeworkList">
									<div class="hwcontent" id="${homeworkList.subjectId}">
												...
												<TR>
													...
													<TD>
														<div class="btn-group">
															...
															<div onclick="unswitch();" class="btn btn-primary">
																Hide</a>
															</div>
													</TD>
												</TR>
										...
										<div class="w3-container">
											<div class="w3-card-4" style="width: 100%">
												...
												<div class="w3-container">
													<br>
													<p>Subject : ${homeworkList.subjectName}</p>
													<hr>
													<div class="author">
														<a href="#"> <img
															src="${pageContext.request.contextPath}/resources/img/faces/teacher1.png"
