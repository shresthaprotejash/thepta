		...
		<div class="sidebar" data-color="blue"
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="active"><a href="/THEPTA/dashboard/viewhomework">
							<p>
					...
					<li><a href="/THEPTA/dashboard/viewtest">
							<p>
								...
								<div class="w3-container">
									...
									<div class="w3-card-4" style="width: 100%">
										...
										<div class="w3-container">
											...
											<div class="author">
												<a href="#"> <img
													src="${pageContext.request.contextPath}/resources/img/faces/teacher2.jpg"
											...
											<p>dear parent</p>
											<p>
												please help your child to complete her homework.It is really
												sad to inform that in today's class she didnt complete her
												last four sum.please pay attention.<br>regards
											</p>
