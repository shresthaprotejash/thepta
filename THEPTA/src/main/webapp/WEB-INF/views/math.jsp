...
<div class="wrapper">
                    ...
                    <div class="col-md-10  col-md-offset-1">
                        <div class="u-card">
							...
							<TR>
							  ...
							  <a href="/THEPTA/dashboard/menu" class="btn btn-primary">Hide</a>
							  </div>
                                 </TD>
  ...
  <div class="w3-card-4" style="width:100%">
    <header class="w3-container w3-light-grey">
      <h3>Ms Vijayashetty</h3>
    </header>
    <div class="w3-container">
		<br>
      <p>period no : I </p>
	  <p>time: 8:15am-9:05am</p>
      <hr>
	  <div class="author">
      <a href="#">
      <img src="${pageContext.request.contextPath}/resources/img/faces/teacher2.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
	  </a>
	  </div>
      <p>dear parent</p>
	  <p>please help your child to complete her homework.It is really sad to inform that in today's class she didnt complete her last four sum.please pay attention.<br>regards</p>
	  
	  <br>
    </div>
    <button class="w3-button w3-block w3-dark-grey">+ chat</button>
  </div>
</div>
