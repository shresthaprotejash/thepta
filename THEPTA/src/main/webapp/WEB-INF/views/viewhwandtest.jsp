		...
		<div class="sidebar" data-color="blue"
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav" id="teachers">
					...
					<li class="active"><a href="/THEPTA/dashboard/viewhwandtest">
							<p>
								<span class="glyphicon glyphicon-chevron-right"></span>View
								Test/Homework
							</p>
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row" align="center">
						<div class="col-sm-3">
							<div class="card"
								onclick="location.href='${pageContext.request.contextPath}/dashboard/viewhomework';">
						...
						<div class="col-sm-3">
							<div class="card"
								onclick="location.href='${pageContext.request.contextPath}/dashboard/viewtest';">
								<div class="card-content">
									<img
